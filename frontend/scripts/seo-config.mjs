...
export const PRERENDER_PAGES = [
  ...
  },
  {
    ...
    description:
      "An honest comparison of ERD Online, draw.io, dbdiagram, and DBML: foreign-key semantics, collaboration, versioning, openness, self-hosting, and Agent/MCP (projectJSON). Prompt suggest-erd-version: create_version; humans still diff.",
  },
  {
    path: "/en/catalog",
    locale: "en-US",
...
export const CF_SPA_REDIRECT_RULES = [
  ...
  "/catalog/:id/ /catalog/ 200",
  "/catalog/creator/:handle /app.html 200",
  "/s/* /app.html 200",
  "/login /app.html 200",
  "/login/* /app.html 200",
  "/register /app.html 200",
  "/register/* /app.html 200",
  "/oauth/authorize /app.html 200",
  "/403 /app.html 200",
  "/project/* /app.html 200",
  "/project/group/setting /app.html 200",
  "/project/group/setting/* /app.html 200",
  "/design/* /app.html 200",
  "/dataModels /app.html 200",
  "/dataModels/* /app.html 200",
  "/home /app.html 200",
  "/home/* /app.html 200",
  "/databaseConfig /app.html 200",
  "/databaseConfig/* /app.html 200",
  "/account /app.html 200",
  "/account/* /app.html 200",
];
