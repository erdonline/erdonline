...
export default {
  ...
  'login.footer.landing': 'Back to home',
  'login.footer.landingAria': 'Back to home',
  ...
  'designer.instrument.syncedAria': 'Autosave: {label}',
  'designer.instrument.errorAria': 'Autosave failed; click to retry',
  ...
  'landing.nav.githubAria': 'View source on GitHub',
  ...
  'landing.hero.cta.browseCatalog': 'Browse templates',
  'landing.hero.cta.browseCatalogAria': 'Browse template catalog',
  ...
  'landing.compare.cell.agentDetail': 'suggest-erd-version; human diffs',
  ...
  'share.fork.cta': 'Copy and edit',
  'share.fork.aria': 'Copy to my projects and edit',
  'share.readonly.tag': 'Public demo',
  ...
  'demo.diagram.d_session': 'Vertical View',
  'demo.group.detail': 'Associations & Detail',
  'demo.group.core': 'Core Entities',
  ...
  'homePage.stat.activeModels': 'Edited today',
  ...
  'homePage.nav.allModels': 'All models',
  ...
  'projectList.type.person': 'Personal project',
  'projectList.type.team': 'Team project',
  'dataModels.typeFilter.aria': 'Filter by project type',
  'dataModels.type.recent': 'Recent',
  'dataModels.type.personal': 'Personal',
  'dataModels.type.team': 'Team',
  ...
  'designLayout.route.fieldLibrary': 'Field library',
