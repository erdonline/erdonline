...
**下一阶段战略（服务北极星，不推翻愿景）**：P2/P3a/P3b 与 P0 四库字典 FK 已齐；推进 **P4 文档站**（`website/` Docusaurus）；存量 eslint warn / AI / i18n 后置。
...
| P4：社区与生态 | 让项目长大 | ~~文档站骨架（`website/`）~~✅；~~GH Pages 工作流 + 死链 fail~~✅；~~本地中文搜索（docusaurus-search-local）~~✅；good-first-issue 运营📋；发版节奏固化✅（`cut-release-notes`） | 🚧 |
