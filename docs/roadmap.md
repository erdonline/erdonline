...
- 下一刀：connector 凭证改走已鉴权 dataSources id（R-DATA-02 残留）；UserController 权限（R-AUTH-02）；SocketIO 成员（R-AUTH-05）
### 用户没说的缺口（主动补齐）📋
