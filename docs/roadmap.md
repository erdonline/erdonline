...
| **P2b：全站控件闭环** | 可点即可达结果；死入口修或删 | 控件矩阵 [control-matrix.md](./control-matrix.md)；~~W0 布局壳~~✅；~~W1 获客会话~~✅；W2 项目面🚧；W3 设计器核心🚧；W4 版本时光机🚧；W5 导入导出+数据源🚧；W6 外围裁剪🚧（死菜单/占位页/假 affordance 已删） | 🚧 |
