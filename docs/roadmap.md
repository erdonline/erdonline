...
**下一阶段战略（服务北极星，不推翻愿景）**：P3a 获客已收口；推进 **P3b 协作锁定**（~~presence 名单~~✅ → 光标/增量 sync）并清 P2 残留（eslint warn / 暗色 ADR）；AI / i18n 后置。
...
| P3：功能深度 | 比竞品强 | ~~版本 diff 可视化~~✅（第 3 轮）；~~协作 presence（ADR-0009；短票+顶栏+断线清名单）~~✅（光标/sync 待续）；~~只读分享链接~~✅（ADR-0007）；~~反向解析 Dialect SPI + schema API + FK~~✅（ADR-0006；字典级 FK/复合键待打磨）；AI📋；i18n📋 | 🚧 |
