...
**下一阶段战略（服务北极星，不推翻愿景）**：P2b 矩阵 🚧 已清零（见 [control-matrix.md](./control-matrix.md)）；余下矩阵 📋 为延期（论坛外链、VIP 角标、实验 query/ChatSQL/dataDomain/dataQuery 等，见矩阵）。**模板广场 MVP ✅**（[ADR-0028](./adr/0028-official-template-catalog.md) 切片 0–5）；P1：评论/举报/hot 排序 📋。
