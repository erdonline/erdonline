...
| www MCP CTA / PAT 弹层 | 08-28 | ✅ 弹层 hint + 落地/Home 次链写明 `suggest-erd-version` / `create_version` 人 diff。**不**发小红书/npm；H1 未改；PAT 不进 URL | locales + PAT Modal | `check:i18n`；pat hint + landing/home E2E |
