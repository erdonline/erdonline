...
- **状态**：✅ 2026-08-28。live（`ec296a9e` Pages [33109350832](https://github.com/erdonline/erdonline/actions/runs/33109350832) success）：未知 ID **200 保原 URL** 列表壳；`_item` **301 → `/catalog/`**；官方 demo-authz 仍独立 title。未请求 GSC。
