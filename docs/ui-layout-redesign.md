...
- ✅ **库方言 apply 可视化编辑**（2026-08-03）：逻辑类型 Modal「库方言映射」密表编 `apply[code].type`；枚举仍 `buildEnumApply`；persist-on-200；`datatype-apply-ux`；下一刀 → ADR-0013（人工）/ P4 demo / DBML Trigger（等官方块）
