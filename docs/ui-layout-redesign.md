...
- ✅ **MySQL 触发器逆向保真**（2026-08-03）：`INFORMATION_SCHEMA.TRIGGERS` → `entity.triggers[]`（name/timing/event/ddl）；`MysqlReverseDialectTriggerTest`；下一刀 → PG/SQL Server/Oracle 触发器 / ADR-0011 复合 FK / ADR-0013
