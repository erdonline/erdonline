...
- ✅ **Group 用户组 Title/左角色签碎距**（2026-08-03）：标题 20→13/22·mb8；去掉 Space large + br；左签 padX24→12·高38→28·字12；`testid=group-setting-page`；`group-layout-nav` densify + `group-keyboard` / `add-user-keyboard` 绿；下一刀 → Group 基本设置 Title level4（视 ROI）
