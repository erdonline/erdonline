...
- ✅ 项目列表行密度：个人/最近/团队共用 `.project-list-page`（标题 13/22、行 pad 4×8、工具条/打开钮 28）；禁 Title level4 + List `large`
...
- ❌ 个人/最近/团队项目列表 Title level4 + List large 松行，与 22–28 chrome 不同阶（历史问题）
