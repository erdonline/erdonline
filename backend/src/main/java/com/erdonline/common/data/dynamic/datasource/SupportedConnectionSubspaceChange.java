 ...
 * @describtion: SupportedConnectionSubspaceChange
 */
@Slf4j
public class SupportedConnectionSubspaceChange {


    private static final Map<DbType, ConnectionSubspaceTypeEnum> DB_TO_NAMESPACE_TYPE = new HashMap<>(5);

    static {
        DB_TO_NAMESPACE_TYPE.put(DbType.postgresql, ConnectionSubspaceTypeEnum.SCHEMA);
        DB_TO_NAMESPACE_TYPE.put(DbType.oracle, ConnectionSubspaceTypeEnum.SCHEMA);
        DB_TO_NAMESPACE_TYPE.put(DbType.db2, ConnectionSubspaceTypeEnum.SCHEMA);
    ...
    public static ConnectionSubspaceTypeEnum getSupportedSubspaceType(Connection connection) throws SQLException {
        return getSupportedSubspaceType(connection, null);
    }
