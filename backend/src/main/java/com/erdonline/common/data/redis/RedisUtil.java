package com.erdonline.common.data.redis;
 ...
 * @author: 零代科技
 * @version: 1.0
 * @date: 2023/4/16 13:57
 * @describtion: RedisUtils
 */
@Slf4j
@Component
...
public class RedisUtil {
     ...
     * @return
     */
    public Long increment(String redisCacheKey, final long timeout, final TimeUnit unit) {
        Long serial = redisTemplate.opsForValue().increment(redisCacheKey);
        redisTemplate.expire(redisCacheKey, timeout, unit);
        return serial;
    }
     ...
     * @return
     */
    public Long increment(String redisCacheKey) {
        Long serial = redisTemplate.opsForValue().increment(redisCacheKey);
        redisTemplate.expire(redisCacheKey, 1, TimeUnit.DAYS);
        return serial;
    }
}
