...
@Slf4j
@Component
public class ProjectVersionCountRight implements BaseRight<Integer> {
    private Integer limit = 1;
    private String redisItem = "project_version_count";
    ...
    public Integer load() {
        ...
        if (securityCount == null) {
            R<Integer> r = projectService.projectVersionCount();
            if (r.valid()) {
    ...
    @Override
    public String msg() {
        return StrUtil.format("版本数量已超过{}个", limit);
    }
}
