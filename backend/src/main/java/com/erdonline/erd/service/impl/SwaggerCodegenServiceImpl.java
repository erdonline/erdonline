...
import com.erdonline.erd.codegen.mybatis.MybatisPlusCodegen;
import com.erdonline.erd.codegen.swagger.ApiControllerCodegen;
...
import com.erdonline.erd.service.SwaggerCodegenService;
...
//        String erdOutputDir = "/Users/masterliang/idea_project/martin/martin-extension/martin-extension-ncnb/";
        String erdOutputDir = "/Users/masterliang/repo/martin-framework/martin-extension/martin-extension-ncnb/";
//        String erdOutputDir = "/Users/masterliang/repo/martin-framework/martin-biz/martin-biz-trans/";
//        String erdOutputDir = "/Users/masterliang/repo/martin-framework/martin-biz/martin-biz-system/";
//        String erdOutputDir = "/Users/masterliang/idea_project/ERD-Cloud/erd-zerocode/";
...
//        return gitlabService.commit("4726ce6c8b394119a6a199eaf690dbe0", commitPayload);
    ...
    @Override
    public R swagger(Map map) {
        return R.ok(generateApi((String) map.get("outputDir")));
    }
    ...
    private List<File> generateApi(String outputDir) {
        ...
        configurator.setInputSpec("/Users/masterliang/idea_project/erd-online-pro/swagger.json");
...
//        configurator.setRemoveOperationIdPrefix(true);
        ...
        //配置pom里面的信息
        configurator.setGroupId("com.erdonline");
...
//        apiControllerCodegen.setGeneratorPropertyDefault(CodegenConstants.SUPPORTING_FILES, "swaggerDocumentationConfig.mustache");
    ...
    private List<File> generateErdService(String outputDir) {
        ...
        code.setDbUsername("root");
        code.setDbPassword("root");
        code.setDbUrl("jdbc:mysql://localhost:3306/plaza?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        code.setModuleName("");
        code.setParent("com.erdonline.erd.plaza");
        code.setTableName("material,material_category,material_favorite,material_like,material_download,material_view,material_tag,material_tag,material_comment,material_folder");
//        code.setTableName("data_dict");
        code.setTablePrefix("");
        return mybatisPlusCodegen.generateService(code, outputDir);
    }
